...
| [Маркетинговые исследования]() | Выявление причин по которым существующие маркетинговые кампании не окупаются,  анализ и поиск решений которые помогут компании увеличить прибыль. | `Pandas` `Matplotlib` `анализ бизнес показателей` |
